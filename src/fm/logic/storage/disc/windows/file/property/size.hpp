#ifndef fm_logic_storage_disc_windows_file_property_size
#define fm_logic_storage_disc_windows_file_property_size
               ...
               , public ::reflection::content::guarded::pure_class< ::fileM::type::size_type, ::fileM::type::size_type const&,::fileM::type::size_type const&, bool>
                {
                 ...
                 public:
                    bool             process( size_type const& size_param ){ return false; }
